...
public class UniGifImage : MonoBehaviour
{
    ...
    [SerializeField]
    public imagescript m_globalImgController;
    ...
    private void Update()
    {
        ...
        //m_globalImgController.UpdateGifFrames(gifIndex);
        //transform.Rotate(0f, 0f, 30f * Time.deltaTime, Space.Self);
        if (m_gifTextureList != null && m_gifTextureList.Count > 0)
        {
            ...
            m_globalImgController.imageToDisplay[gifIndex].material.mainTexture = m_gifTextureList[m_gifTextureIndex].m_texture2d;
            m_globalImgController.imageToDisplay[gifIndex].material.SetTexture("_EmissionMap", m_gifTextureList[m_gifTextureIndex].m_texture2d);
            m_delayTime = Time.time + m_gifTextureList[m_gifTextureIndex].m_delaySec;
        }
    }
        ...
        using (WWW www = new WWW(path))
        {
            ...
            yield return StartCoroutine(UniGif.GetTextureListCoroutine(www.bytes, (gifTexList, loopCount, width, height) =>
            {
                if (gifTexList != null)
                {
                    ...
                    if (autoPlay)
                    {
                        //m_globalImgController.SetGifImages(m_gifTextureList);
                        //m_gifTextureIndex = 0;
